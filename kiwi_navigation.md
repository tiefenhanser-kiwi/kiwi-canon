<!-- ============================================================
     MIRROR COPY — generated 2026-09-07 13:52Z (UTC) by chat-Claude from Claude project knowledge.
...
| Latest workstream summary (post-freeze) | `kiwi_ws{N}_complete_handoff.md` for most recent frozen workstream | ~10-20 KB each |
...
| A1 design direction + June 12 flow rulings R1–R6 + screen audit | `kiwi_ux_redesign_handoff.md` | R1 AMENDED July 3 (one Tell Kiwi card, two chips) — see `kiwi_ws9_plan.md` §2 |
| A1 design tokens (LOCKED) + visual mockups | `design-tokens_4.ts` · `kiwi_prep_cook_mockup.html` · `kiwi_screens_mockup.html` | ⚠️ **The June token doc has DRIFTED from the repo** (at minimum `sectionLabel.color` and the placeholder value). **`artifacts/kiwi/constants/tokens.ts` is the only truth for tokens** — that is why the doc is excluded from the local canon mirror. Mockups are references, not specs — meal photos are placeholder stock |
...
| PRD locked version (pre-1.1 redlines) | `kiwi_prd_v1_0_locked.md` | Reference only when v1.1 working has ambiguity about a redline vs locked spec |
...
| WS5 | Meal swap (extended) | ✅ FROZEN | `kiwi_ws5_complete_handoff.md` |
| WS6 | AI orchestration | ✅ FROZEN (May 18, 2026) | `kiwi_ws6_complete_handoff.md` |
